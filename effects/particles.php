...
<head>
    ...
    <title>Particle Storm &middot; FFSS</title>
    ...
    <link rel="stylesheet" href="<?= $us_url_root ?>assets/css/effect-particles.css">
</head>
<body class="ffss-effect-body">
    ...
    <script src="<?= $us_url_root ?>assets/js/effect-particles.js"></script>
</body>
</html>
