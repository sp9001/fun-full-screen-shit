...
<head>
    ...
    <title>Plasma Flow &middot; FFSS</title>
    ...
    <link rel="stylesheet" href="<?= $us_url_root ?>assets/css/effect-plasma.css">
</head>
<body class="ffss-effect-body">
    ...
    <script src="<?= $us_url_root ?>assets/js/effect-plasma.js"></script>
</body>
</html>
